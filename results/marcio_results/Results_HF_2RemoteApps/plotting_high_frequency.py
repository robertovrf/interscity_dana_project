...
file2 = open("Results_HF_Cache_2RemoteApps.data", "r") 
for line2 in file2: 
	j2 = json.loads(line2)
...
file3 = open("Results_HF_Compression_2RemoteApps.data", "r") 
for line3 in file3: 
	j3 = json.loads(line3)
...
file4 = open("Results_HF_CacheAndCompression_2RemoteApps.data", "r") 
for line4 in file4: 
	j4 = json.loads(line4)
