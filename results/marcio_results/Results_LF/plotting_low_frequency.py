...
#getting data
file = open("Results_LF_SGBD_2RemoteApps.data", "r") 
for line in file: 
	j = json.loads(line)
...
file2 = open("Results_LF_Cache_2RemoteApps.data", "r") 
for line2 in file2: 
	j2 = json.loads(line2)
...
file3 = open("Results_LF_Compression_2RemoteApps.data", "r") 
for line3 in file3: 
	j3 = json.loads(line3)
...
file4 = open("Results_LF_CacheAndCompression_2RemoteApps.data", "r") 
for line4 in file4: 
	j4 = json.loads(line4)
...
#plotting graph
fig, ax = plt.subplots()
ax.plot(xValues, yValues, label='Nocache')
